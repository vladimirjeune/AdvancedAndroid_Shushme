...
public class MainActivity extends AppCompatActivity implements
    ...
    private static final int PLACEPICKER_INTENT_REQUEST_CODE = 119;
    ...
    public void onAddPlaceButtonClicked(View view) {
        ...
        try {
            ...
            startActivityForResult(placePickerIntent, PLACEPICKER_INTENT_REQUEST_CODE);
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if ( (PLACEPICKER_INTENT_REQUEST_CODE != requestCode) || (RESULT_OK != resultCode) ) {
            return;
        }
        ...
        if (data != null) {
            ...
            placeContentValues.put(PlaceContract.PlaceEntry.COLUMN_PLACE_ID, placeId);

            getContentResolver().insert(PlaceContract.BASE_CONTENT_URI, placeContentValues);
        }
